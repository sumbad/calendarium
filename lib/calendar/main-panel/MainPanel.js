...
var MainPanel = (function (_super) {
    ...
    MainPanel.prototype.render = function () {
        ...
        return (React.createElement("div", {className: calendarStyle["main-panel"]}, React.createElement("label", {onClick: this.handleClickDay.bind(this), className: calendarStyle["chosen-day"] + " " + (this.state.chosen === "day" ? calendarStyle["selected"] : "")}, day), React.createElement("label", {onClick: this.handleClickMonth.bind(this), className: calendarStyle["chosen-month"] + " " + (this.state.chosen === "month" ? calendarStyle["selected"] : "")}, month), React.createElement("label", {onClick: this.handleClickYear.bind(this), className: calendarStyle["chosen-year"] + " " + (this.state.chosen === "year" ? calendarStyle["selected"] : "")}, year), React.createElement("label", {className: calendarStyle["chosen-time"]}, React.createElement("div", {className: calendarStyle["chosen-time__hour"] + " " + (this.state.chosen === "hour" ? calendarStyle["selected"] : "")}, React.createElement("div", {onClick: this.handleClickHoursArrowUp.bind(this), className: calendarStyle["arrow-up"]}), React.createElement("span", {onClick: this.handleClickHours.bind(this)}, hours), React.createElement("div", {onClick: this.handleClickHoursArrowDown.bind(this), className: calendarStyle["arrow-down"]})), React.createElement("div", {className: calendarStyle["chosen-time__colon"]}, React.createElement("span", null, ": ")), React.createElement("div", {className: calendarStyle["chosen-time__minute"] + " " + (this.state.chosen === "minute" ? calendarStyle["selected"] : "")}, React.createElement("div", {onClick: this.handleClickMinutesArrowUp.bind(this), className: calendarStyle["arrow-up"]}), React.createElement("span", {onClick: this.handleClickMinutes.bind(this)}, minutes), React.createElement("div", {onClick: this.handleClickMinutesArrowDown.bind(this), className: calendarStyle["arrow-down"]})))));
    };
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // ADDITIONAL METHODS
    //
