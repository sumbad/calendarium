...
var MainPanel = (function (_super) {
    ...
    MainPanel.prototype.render = function () {
        ...
        var year = DateUtilities_1.DateUtilities.toYearString(this.props.selectedDate);
        var hours = DateUtilities_1.DateUtilities.toHoursString(this.props.selectedDate);
        var minutes = DateUtilities_1.DateUtilities.toMinutesString(this.props.selectedDate);
