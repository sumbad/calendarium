...
var Years = (function (_super) {
    ...
    Years.prototype.render = function () {
        ...
        var years = this.state.years.map(function (year) {
            var selected = _this.props.selectedDate.getFullYear() == year ? calendarStyle["selected"] : "";
            return (React.createElement("li", {key: year, onClick: _this.handleClickYear.bind(_this, year), className: calendarStyle["year"] + " " + selected}, year));
        });
        var years1col = years.slice(0, 6);
        var years2col = years.slice(6, 12);
        return (React.createElement("div", {className: calendarStyle["years"]}, React.createElement("div", {onClick: this.handleClickArrowLeft.bind(this), className: calendarStyle["arrow-left"]}), React.createElement("div", {className: calendarStyle["years-columns"]}, React.createElement("ul", null, years1col), React.createElement("ul", null, years2col)), React.createElement("div", {onClick: this.handleClickArrowRight.bind(this), className: calendarStyle["arrow-right"]})));
    };
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // ADDITIONAL METHODS
    //
